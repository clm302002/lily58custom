...
// #include "print.h"  // this isnt defined anywhere?
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T, KC_F2,            KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_MINS,
  KC_LCTL,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G, KC_F3,            KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
